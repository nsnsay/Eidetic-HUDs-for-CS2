...
export default {
	...
	methods: {
		...
		hasValidScores(mapNumber) {
			...
			const pickTeamScore = this.$opts[`series.maps.${mapNumber}.pickTeamScore`];
			const enemyTeamScore = this.$opts[`series.maps.${mapNumber}.enemyTeamScore`];
			return pickTeamScore !== '' && pickTeamScore !== 0 && enemyTeamScore !== '' && enemyTeamScore !== 0;
		},
